...
The purpose of this guide is to describe how to contribute to the Galaxy Slicer translations. We use GNUgettext for extracting string resources from the project and PoEdit for editing translations.
...
### Scenario 3. How do I add a new text resource when implementing a feature to Galaxy Slicer
Each string resource in Galaxy Slicer available for translation needs to be explicitly marked using L() macro like this:
```C++
...
### Scenario 4. How do I use GNUgettext to localize my own application taking Galaxy Slicer as an example
...
## General guidelines for Galaxy Slicer translators
...
- To check how the translated text looks on the UI elements, test it :) If you use *PoEdit*, all you need to do is save the file. At this point, a MO file will be created. Rename it Galaxy Slicer.mo, and you can run Galaxy Slicer (see above).

- If you see an encoding error (garbage characters instead of Unicode) somewhere in Galaxy Slicer, report it. It is likely not a problem of your translation, but a bug in the software.
