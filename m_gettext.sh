...
do
    ...
    if [ -f "$dir/GalaxySlicer_${lang}.po" ]; then
        if $FULL_MODE; then
            ...
            msgcat --use-first $dir/GalaxySlicer_${lang}.po /Users/runner/work/OrcaSlicer/OrcaSlicer/localization/i18n/${lang}/OrcaSlicer_${lang}.po -o $dir/GalaxySlicer_${lang}.po
         fi
