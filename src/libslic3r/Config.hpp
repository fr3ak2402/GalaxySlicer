...
// When parsing a configuration value, if the old_value is not understood by this GalaxySlicer version,
// it is being substituted with some default value that this GalaxySlicer could work with.
