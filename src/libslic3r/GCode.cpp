...
//            config.set_key_value("max_layer_z", new ConfigOptionFloat(m_max_layer_z));
        ...
        //SoftFever (OrcaSlicer): set new PA for new filament
...
void GCode::_do_export(Print& print, GCodeOutputStream &file, ThumbnailsGeneratorCallback thumbnail_cb)
{
      ...
      // PrusaSlicer G-code viewer.
    {
      if (is_bbl_printers) {
        ...
        // GalaxySlicer: write compatiple image
...
//        print_object_instances_ordering = sort_object_instances_by_max_z(print);
    ...
    float outer_wall_volumetric_speed = 0.0f;
    {
        ...
        // GalaxySlicer: support variables `first_layer_temperature` and `first_layer_bed_temperature`
...
*/
    ...
    if (!is_bbl_printers) {
      ...
      // GalaxySlicer: write compatiple info
      int first_layer_bed_temperature = get_bed_temperature(0, true, print.config().curr_bed_type);
      file.write_format("; first_layer_bed_temperature = %d\n", first_layer_bed_temperature);
...
std::string GCode::extrude_loop(ExtrusionLoop loop, std::string description, double speed)
{
    ...
    // GalaxySlicer: check loop lenght for small perimeter. 
