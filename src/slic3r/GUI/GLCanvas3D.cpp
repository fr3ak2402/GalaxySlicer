...
void GLCanvas3D::LayersEditing::render_variable_layer_height_dialog(const GLCanvas3D& canvas) {
    ...
    ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(0.42f, 0.23f, 0.44f, 0.00f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(0.42f, 0.23f, 0.44f, 0.00f));
...
//#endif
        ...
        // do not process the dragging if the left mouse was set down in another canvas
            ...
            // Galaxy: Sphere rotation for painting view 
...
void GLCanvas3D::_picking_pass()
{
    ...
    // Galaxy: ignore clipping plane if not applying
