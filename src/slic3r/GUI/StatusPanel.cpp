...
static const wxColour BUTTON_HOVER_COL   = wxColour(105, 58, 113);
...
static const wxColour STAGE_TEXT_COL      = wxColour(105, 58, 113);
...
wxBoxSizer *StatusBasePanel::create_project_task_page(wxWindow *parent)
{
   ...
   /* m_button_report = new Button(m_panel_progress, _L("Report"));
    ...
    m_staticText_progress_percent->SetForegroundColour(wxColour(105, 58, 113));
    ...
    m_staticText_progress_percent_icon->SetForegroundColour(wxColour(105, 58, 113));
...
wxBoxSizer *StatusBasePanel::create_machine_control_page(wxWindow *parent)
{
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(AMS_CONTROL_DISABLE_COLOUR, StateColor::Disabled), std::pair<wxColour, int>(wxColour(199, 172, 203), StateColor::Pressed),
...
wxBoxSizer *StatusBasePanel::create_misc_control(wxWindow *parent)
{
    ...
    m_switch_nozzle_fan->Bind(wxEVT_ENTER_WINDOW, [this](auto& e) {
        m_fan_panel->SetBackgroundColor(wxColour(105, 58, 113));
    });
