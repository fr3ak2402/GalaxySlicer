...
#define EXTRUSION_CALIBRATION_DEF_COLOUR    wxColour(#ffffff)
#define EXTRUSION_CALIBRATION_GREY900       wxColour(#262e30)
#define EXTRUSION_CALIBRATION_GREY800       wxColour(#323a3d)
#define EXTRUSION_CALIBRATION_GREY700       wxColour(#6b6b6b)
#define EXTRUSION_CALIBRATION_GREY300       wxColour(#eeeeee)
#define EXTRUSION_CALIBRATION_GREY200       wxColour(#f8f8f8)
