...
enum GalaxySlicerMenuIDs {
  GalaxySlicerMenuAbout,
  GalaxySlicerMenuPreferences,
};
...
//#endif
  ...
  public:
    ...
    std::string logo_name() const { return is_editor() ? "GalaxySlicer" : "GalaxySlicer-gcodeviewer"; }
...
//#endif
    ...
    void            check_new_galaxyslicer_version(bool show_tips = false, int by_user = 0);
