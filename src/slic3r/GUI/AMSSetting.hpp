...
#define AMS_SETTING_DEF_COLOUR wxColour(#ffffff)
#define AMS_SETTING_GREY800 wxColour(#323a3d)
#define AMS_SETTING_GREY700 wxColour(#6b6b6b)
#define AMS_SETTING_GREY200 wxColour(#f8f8f8)
