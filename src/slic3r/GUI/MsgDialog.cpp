...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "GalaxySlicer", this, 64, style & wxICON_ERROR));
}
	...
	, msg(msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("GalaxySlicer_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/84));
