...
wxString get_fail_reason(int code)
{
     ...
     : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, _L("Log in printer"), wxDefaultPosition, wxDefaultSize, wxCAPTION)
 {
     ...
     m_st_privacy_title->SetForegroundColour(wxColour(0x262e30));
     ...
     m_link_Terms_title->SetForegroundColour(wxColour(0x693a71)); 
     ...
     m_st_and_title->SetForegroundColour(wxColour(0x262e30));
     ...
     m_link_privacy_title->SetForegroundColour(wxColour(0x693a71));
     ...
     m_st_notice_title->SetForegroundColour(wxColour(0x262e30));
     ...
     m_link_notice_title->SetForegroundColour(wxColour(0x693a71));
