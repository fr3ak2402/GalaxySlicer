...
@ECHO                  console - run and wait on galaxy-slicer-console.exe
...
@ECHO                  window - run galaxy-slicer.exe (no wait)
@ECHO                Default: none
...
IF "%PS_RUN%" EQU "console" (
    icacls galaxy-slicer-console.exe >nul || GOTO :END
    start /wait /b galaxy-slicer-console.exe
) ELSE IF "%PS_RUN%" EQU "window" (
    icacls galaxy-slicer.exe >nul || GOTO :END
    start galaxy-slicer.exe
